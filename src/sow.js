...
function scopeParagraph(result, rules) {
  ...
  parts.push(
    `Work includes ${qtyText(q.hangerQty)} hidden hangers, ` +
    `${qtyText(q.elbowQty)} elbows, ${qtyText(q.miterQty)} mitered corners, ` +
    `${qtyText(q.endCapQty)} end caps and ${qtyText(q.strapQty)} downspout ` +
    'straps, together with sealant, fasteners and all labor to complete the ' +
